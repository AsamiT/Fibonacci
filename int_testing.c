/**
    ...
    @desc: "This file's purpose is to test converting an integer
            to an unsigned integer as specified in testcase02."

    File only works when compiled using Debug mode!
